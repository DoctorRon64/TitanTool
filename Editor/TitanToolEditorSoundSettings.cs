    ...
    public class TitanToolEditorSoundSettings : ScriptableObject {
        ...
        private static AudioClip GetPackageDefaultClip(TitanToolEditorSoundEvent soundEvent) {
            ...
            string fileName = soundEvent switch {
                ...
                TitanToolEditorSoundEvent.GraphOpened => "graph_open.mp3",
                TitanToolEditorSoundEvent.GraphCreated => "graph_create.mp3",
                TitanToolEditorSoundEvent.GraphDetached => "graph_detached.mp3",
                TitanToolEditorSoundEvent.SelectionAligned => "wire_add.mp3",
                TitanToolEditorSoundEvent.CommentCreated => "add_comment.mp3",
                TitanToolEditorSoundEvent.WireSplit => "wire_add.mp3",
                TitanToolEditorSoundEvent.ProviderCreated => "provider_created.mp3",
                TitanToolEditorSoundEvent.ProviderAssigned => "provider_assigned.mp3",
