...
namespace TitanTool.Editor.Nodes {
    ...
    [GraphNode(typeof(TitanTool.Runtime.Nodes.Base.WeightedRandomSelectorNode), "Pick Weighted Child", "Composite/", BossGraphNodeCategory.Composite, tooltip: "Chooses one connected child at random using per-child weights. Higher weights make a branch more likely to be picked.")]
    public class WeightedRandomSelectorNode : BossGraphNode, IRuntimeNodeCompiler, IGraphNodeValidator {
        ...
        public void Validate(BossGraphNodeValidationContext context) {
            ...
            if (connectedChildren < minimumChildCount) {
                context.Error("Weighted Random Selector must have at least two connected children.");
